...
service "apache2" do
  ...
  when "rhel", "fedora", "suse"
    ...
    restart_command "/sbin/service httpd restart && sleep 3"
    reload_command "/sbin/service httpd reload && sleep 3"
  when "debian"
    service_name "apache2"
    restart_command "/usr/sbin/invoke-rc.d apache2 restart && sleep 3"
    reload_command "/usr/sbin/invoke-rc.d apache2 reload && sleep 3"
  when "arch"
    service_name "httpd"
  when "freebsd"
